(()=>{
  ...
  function boot(){document.title="LiveVoz V14.1 Stage Director";const sub=document.querySelector(".brand-sub");if(sub)sub.textContent="V14.1 · STAGE DIRECTOR · CONCERT RELIABILITY";ensureChip();recoverView();networkWatch();staleWatch();startHeartbeat();installRecoveryButton();if(!navigator.onLine)setChip("sin conexión · modo supervivencia","bad");else if(wsBase())setTimeout(()=>connectWebSocket({silent:true}),350);console.info("LiveVoz V14.1 reliability activo");}
